    ...
    <section class="q-mb-xl">
      ...
      <div class="bg-primary q-pa-xs">
        <div class="bg-dark text-white">
          ...
          aut eaque fuga impedit distinctio dignissimos exercitationem sint
          laboriosam eveniet facilis ipsum dolorum officia alias, commodi velit
          pariatur, dolore accusamus voluptatum.
        </div>
      </div>
