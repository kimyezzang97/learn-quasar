<template>
  <q-page class="q-pa-xl">
    ...
    <section>
      ...
      <p class="text-weihgt-thin">
        Lorem ipsum dolor sit amet consectetur adipisicing elit.
      </p>
      <p class="text-weihgt-medium">
        Lorem ipsum dolor sit amet consectetur adipisicing elit.
      </p>
      <p class="text-weihgt-border">
        Lorem ipsum dolor sit amet consectetur adipisicing elit.
      </p>
    </section>
    <section>
      <div class="text-h4">CSS Helper Classes</div>
      <p class="text-weihgt-thin text-right">
        Lorem ipsum dolor sit amet consectetur adipisicing elit.
      </p>
      <p class="text-weihgt-medium text-center">
        Lorem ipsum dolor sit amet consectetur adipisicing elit.
      </p>
      <p class="text-weihgt-border text-strike">
        Lorem ipsum dolor sit amet consectetur adipisicing elit.
      </p>
    </section>
  </q-page>
